...
from imports import Thread, Event, queue
load_dotenv(".env")
...
def weather(data,event,q):#(dp,user_id):
    ...
    completion = openai.ChatCompletion.create(model="gpt-3.5-turbo", messages=[{"role": "user", "content": prompt}], max_tokens=170)["choices"][0]["message"]["content"]
...
if __name__  == "__main__":
    q5 = queue.Queue()
    event5 = Event()
    places({"GEO":{"city":"Москва"}, "TIME":{"month":5}},event5,q5)
